...
import EditStylesModalTaskList from './EditModalTaskList.module.css';
      ...
      {checklists.map((checklist) => (
        ...
        {  console.log("checklist._id=====",checklist._id)}
          ...
          <input
            ...
            className={EditStylesModalTaskList.inputTask}
          />
          <button className={EditStylesModalTaskList.deleteButton} onClick={() => handleDeleteClick(checklist._id)}>
            <img src="Assets/delete.svg" alt="delete" />
          </button>
        </div>
      ))}
      <br/>
      <div className={EditStylesModalTaskList.addButton} onClick={handleAddNewClick}>
